...
namespace UserRolesData.Migrations
{
    ...
    [Migration("20230710070851_changed one column name in Prescriptions table")]
    partial class changedonecolumnnameinPrescriptionstable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserRolesData.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UserRolesModels.TicketStatus", b =>
                {
                    b.Property<int>("TicketStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UserRolesData.Model.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UserRolesModels.CustomerInvoice", b =>
                {
                    ...
                    b.HasOne("UserRolesModels.TicketStatus", "TicketStatus")
                        .WithMany("CustomerInvoices")
            ...
            modelBuilder.Entity("UserRolesModels.Product", b =>
                {
                    ...
                    b.HasOne("UserRolesModels.Colour", "Colour")
                        .WithMany("Products")
